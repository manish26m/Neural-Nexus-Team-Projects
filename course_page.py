...
class CoursesApp(tk.Tk):
    def __init__(self):
        ...
        # Right logo
        logo_path = r"C:\Users\94901\OneDrive\Desktop\qwerty\right_logo.jpg"
        logo = Image.open(logo_path)
        logo = logo.resize((80, 80), Image.LANCZOS)
        self.logo_image = ImageTk.PhotoImage(logo)

        # Left logo
        left_logo_path = r"C:\Users\94901\OneDrive\Desktop\qwerty\left_logo.jpg"
    ...
    def create_course_cards(self, parent, courses):
        ...
        for index, course in enumerate(courses):
            ...
            open_btn = tk.Button(card, text="Open", font=('Arial', 12), bg='blue', fg='white', padx=10, pady=5, command=lambda c=course: self.open_course(c))
